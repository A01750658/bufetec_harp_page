...
//Función para agregar days in days con la clase day and prev-date next-date en el mes anterior y próximos días del mes
...
function getData(){
  const name = document.getElementById("name").value;
    ...
    time = citasArr[citasArr.length - 1];
  const date =  month + "/" + day + "/" + year; 
  alert("Tu cita ha sido agendada con éxito el " + date + " a las " + time);

  const dataArr = day + ";" + month + ";" + year + ";" + time + ";" + name + ";" + numberOne + ";" + numberTwo + ";" + emailOne + ";" + emailTwo + ";" + asunto + ";" + explain + "\n";
  
  alert(dataArr);
  load.addData(name, asunto, date, time, emailOne, emailTwo, numberOne, numberTwo, explain);
}
